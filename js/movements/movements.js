...
function moveCameraToCurrentMotorcycle(player_camera, current_moto, player_orientation){
    ...
    if (player_orientation == 1) player_camera.position.y = current_moto.position.y - camera_remoteness;
    else if (player_orientation == 2) player_camera.position.x = current_moto.position.x - camera_remoteness;
    else if (player_orientation == 3) player_camera.position.y = current_moto.position.y + camera_remoteness;
    ...
    function keyPressed(keyboardEvent) {
        switch(keyboardEvent.key) {
            case 'ArrowRight':
                ...
                if (player_1_orientation > 4) player_1_orientation = 1;
            ...
            case 'ArrowLeft':
                ...
                if (player_1_orientation < 1) player_1_orientation = 4;
                moveCameraToCurrentMotorcycle(player_1_camera, current_motorcycle, player_1_orientation);
